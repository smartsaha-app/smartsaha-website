<template>
  <div>
    ...
    >
      ...
      >
        <div
          class="flex-1 flex flex-col justify-center gap-2 text-white"
          data-aos="fade-up"
        >
          <h5
            class="rounded-full w-max bg-white/10 backdrop-blur-md border border-white/20 inline-flex items-center gap-2 px-5 py-2 uppercase text-xs tracking-[0.2em] font-bold text-white shadow-sm"
          >
            <span
          ...
          <h1
            class="text-3xl sm:text-5xl lg:text-6xl font-extrabold leading-tight mb-4 tracking-tight max-w-4xl"
          >
            {{ t("portfolioHeroTitle") }}
          </h1>

          <p
            class="text-gray-200 max-w-2xl text-base sm:text-lg font-light leading-relaxed"
          >
            {{ t("portfolioHeroText") }}
          </p>
    ...
    >
      <div class="max-w-7xl mx-auto px-4 sm:px-6">
        ...
        >
          <span
            class="text-[#10b481] font-bold text-xs sm:text-sm uppercase tracking-widest bg-[#10b481]/10 px-4 py-1.5 rounded-full border border-[#10b481]/20"
          >
            {{ t("projectsBadge") }}
          </span>

          <h2
            class="text-3xl sm:text-4xl font-extrabold text-gray-800 dark:text-white mt-4 mb-4"
          >
            {{ t("projectsTitle") }}
          </h2>

          <p
            class="text-gray-600 dark:text-gray-300 text-sm sm:text-base leading-relaxed"
          >
            {{ t("projectsSubtitle") }}
          </p>
        </div>
        ...
        >
          <i
            class="bx bx-briefcase-alt-2 text-5xl text-gray-400 mb-3"
            aria-hidden="true"
          ></i>
        ...
        >
          ...
          >
            ...
            >
              ...
              <div
                class="absolute inset-0 bg-gradient-to-t from-[#112830] via-transparent to-transparent opacity-60 group-hover:opacity-80 transition-opacity"
              ></div>
              ...
              >
                <span
                  class="p-3 bg-white/20 backdrop-blur-md text-white rounded-full text-2xl hover:scale-110 transition-transform shadow-lg"
                >
            ...
            <div class="p-6 flex-1 flex flex-col justify-between">
              <div>
                ...
                >
                  <h3
                    class="text-xl font-bold text-gray-800 dark:text-white mb-2 group-hover:text-[#10b481] transition-colors leading-snug"
                  >
                    {{ project.title }}
                  </h3>
                </NuxtLink>
                ...
                <p
                  class="text-gray-600 dark:text-gray-300 text-sm line-clamp-3 mb-6 leading-relaxed"
                >
                  {{ project.description }}
                </p>
              </div>
              ...
              <div
                class="border-t border-gray-100 dark:border-white/10 pt-4 mt-auto flex items-center justify-between"
              >
                <NuxtLink
                  :to="
                    localePath({
                ...
                >
                  ...
                  <i
                    class="bx bx-chevron-right text-lg group-hover/link:translate-x-1 transition-transform"
                  ></i>
                </NuxtLink>
              </div>
            </div>
...
const {
  ...
  `${config.public.apiBase}/portfolios/list`,
  {
    ...
    /*
     * Très important :
     * lorsque locale change :
     *
     * fr → en
     * en → mg
     * mg → fr
     *
     * Nuxt refait automatiquement la requête.
     */
    watch: [locale],

    /*
     * Évite qu'une ancienne réponse soit réutilisée
...
const projects = computed(() => {
  ...
  return raw.map((p: any) => ({
    ...
    /*
     * Ces valeurs viennent maintenant directement
     * du backend selon ?locale=fr/en/mg
     */
    title: p.title ?? "",
